...
<script type="text/javascript">
	...
	function changeCount(id, count, max) {
		...
		location.href = "${pageContext.request.contextPath}/cart/update?id=" + id
				+ "&count=" + count;
	...
	function gotoorder(){
		...
		location.href="${pageContext.request.contextPath}/cart/preorder";	
	}
</script>
</head>
			...
			<table align="center" border="1">
				...
				<c:forEach items="${cart}" var="entry">
					...
					<tr>
						...
						<td><a
							href="${pageContext.request.contextPath}/cart/remove?id=${entry.key.id}"
